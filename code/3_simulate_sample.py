...
사용 예 (WSL 환경):
    ...
    python ./code/3_simulate_sample.py
------------------------------------------------------------
...
Input:
  - efield/600us_50Hz_10umspaing_100mA/grad_Exdx_Eydy_Ezdz_2cycle.npy, shape (3, Nx, Ny, Nz, Nt)
  - efield/600us_50Hz_10umspaing_100mA/E_field_grid_coords.npy, shape (N_spatial, 3) in meters
...
# Ensure project root can be imported when script runs from code/ or other cwd.
...
SCRIPT_DIR = Path(__file__).parent
BASE_DIR = SCRIPT_DIR.parent  # D:\yongtae\neuron

# Available folders (uncomment the one to process)
# FOLDER_NAME = "800us_50Hz_10umspaing_100mA"  # 주석 처리: 800us 폴더
FOLDER_NAME = "600us_50Hz_10umspaing_100mA"  # 활성화: 600us 폴더

GRAD_VALUES_FILE = BASE_DIR / "efield" / FOLDER_NAME / "grad_Exdx_Eydy_Ezdz_2cycle.npy"
E_GRID_COORDS_FILE = BASE_DIR / "efield" / FOLDER_NAME / "E_field_grid_coords.npy"
...
DEFAULT_GAINS = tuple([1.0, 5.0, 10.0, 20.0])  # 1, 5, 10, 20배
DEFAULT_GAINS_STR = "1,5,10,20"
GRAD_GAIN = 1.0

# Gain-to-current mapping for output labels (mA)
GAIN_TO_MA = {
    1.0: 100,
    5.0: 500,
    10.0: 1000,
