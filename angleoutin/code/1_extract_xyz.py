...
STEPS_PER_CYCLE = 100  # 1사이클당 파일 개수
TOTAL_STEPS = STEPS_PER_CYCLE * NUM_CYCLES  # 총 시간 스텝 수

# 출력 파일 경로 (efield 폴더에 저장)
OUTPUT_E_FIELD_FILE = os.path.join(EFIELD_BASE_DIR, f"1_E_field_{NUM_CYCLES}cycle.npy")
OUTPUT_COORDS_FILE = os.path.join(EFIELD_BASE_DIR, "1_E_field_grid_coords.npy")
