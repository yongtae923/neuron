...
- Input: angleoutin/data/30V_OUT10_IN20_CI/7_gradient_allen/v2_allpoints_gradient_*x_cell*.npy
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path(s) to v2 summary npy. Comma-separated allowed. Default: load all v2_* in ../data/30V_OUT10_IN20_CI/7_gradient_allen",
    )
    parser.add_argument(
        "--cell",
        type=str,
    ...
    if not input_paths:
        msg = (
            ...
            "Check ../data/30V_OUT10_IN20_CI/7_gradient_allen/v2_allpoints_gradient_*x_cell*.npy"
        )
        if args.cell:
